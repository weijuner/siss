    ...
    class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener{
        ...
        public void onClick(int itemId, View view) {
            ...
            case ITEM_PICTURE:
                selectPicFromLocal();
                break;
            case ITEM_LOCATION://推荐
          //      startActivityForResult(new Intent(getActivity(), EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
                //发送一条扩展消息
                Log.e("tag","ITEM_LOCATION");
                EMMessage message = EMMessage.createTxtSendMessage("推荐一个好房源",toChatUsername);
                message.setChatType(ChatType.GroupChat);
                message.setAttribute("title", "有一个好房源推荐给你");
                message.setAttribute("icon", "http://imgtu.5011.net/uploads/content/20161115/5635261479187659.jpg");
                //   message.setAttribute("activityID", activityID);
                message.setAttribute("senderid", "zwj");
