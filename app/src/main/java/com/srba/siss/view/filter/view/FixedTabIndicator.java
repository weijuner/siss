package com.srba.siss.view.filter.view;
...
import com.srba.siss.view.filter.adapter.MenuAdapter;
import com.srba.siss.view.filter.util.UIUtil;
...
public class FixedTabIndicator extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        mLinePaint.setStrokeWidth((float) 2.0);              //设置线宽
    ...
    protected void onDraw(Canvas canvas) {
     ...
     //   canvas.drawRect(0, measureHeight - mLineHeight, measuredWidth, measureHeight, mLinePaint);
        Timber.e(measureHeight+"---"+measuredWidth);
        canvas.drawLine(0, measureHeight,  measuredWidth, measureHeight, mLinePaint);
    }
     ...
     * @param pos   textview位置
     * @return  包裹着textview的relativelayout
     */
