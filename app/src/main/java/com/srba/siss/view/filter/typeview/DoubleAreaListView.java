...
import com.srba.siss.adapter.FilterListAdapter;
import com.srba.siss.view.filter.adapter.BaseBaseAdapter;
import com.srba.siss.view.filter.util.CommonUtil;
...
public class DoubleAreaListView<LEFTD, RIGHTD> extends LinearLayout implements AdapterView.OnItemClickListener {
    ...
    private void init(Context context) {
        ...
        inflate(context, R.layout.popup_window_area, this);
    ...
    public DoubleAreaListView<LEFTD, RIGHTD> leftAdapter(FilterListAdapter<LEFTD> leftAdapter) {
        mLeftAdapter = leftAdapter;
        lv_left.setAdapter(leftAdapter);
        return this;
    }

    public DoubleAreaListView<LEFTD, RIGHTD> rightAdapter(FilterListAdapter<RIGHTD> rightAdapter) {
